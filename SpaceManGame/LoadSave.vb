Module LoadSave
    ...
    Sub init_resources()
        ...
        planet_tile_texture(planet_tile_type_enum.Desert_Planet) = Direct3D.TextureLoader.FromFile(d3d_device, Application.StartupPath + "\Data\Textures\Tiles\Desert_Planet.png", 640, 32, 0, Direct3D.Usage.None, Texture_Format, Direct3D.Pool.Managed, Filter, MipFilter, 0)
